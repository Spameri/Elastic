...
class Technical implements \Spameri\Elastic\Entity\IEntity
{
	...
	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Camera
	 */
	private $camera;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Runtime
	 */
	private $runtime;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Color
	 */
	private $color;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Ratio
	 */
	private $ratio;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Laboratory
	 */
	private $laboratory;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\FilmLength
	 */
	private $filmLength;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\NegativeFormat
	 */
	private $negativeFormat;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\CineProcess
	 */
	private $cineProcess;

	/**
	 * @var \SpameriTests\Data\Entity\Video\Technical\Printed
	 */
	private $printed;
